...
if (-not $backendReady) {
    ...
    $backendProcess = Start-Process -FilePath "cmd" -ArgumentList "/k", "cd /d $backendDir && mvn -DskipTests -Dspring-boot.run.profiles=dev spring-boot:run -q" -NoNewWindow -PassThru
